...
function About() {
  return (
    <section className="bg-[#1F5F4B] min-h-screen py-20 px-7 md:px-20 text-black">
      ...
      <div className="max-w-5xl mx-auto bg-white/30 p-10 rounded-md text-black">
  <ul className="space-y-6 text-base font-bold list-none">
    ...
    <li>
      • I’m also a huge cricket fan. And every time legends like <span className="font-bold">SACHIN TENDULKAR, RAHUL DRAVID AND VIRAT KOHLI</span> talk about game awareness, they echo something simple: <br />
